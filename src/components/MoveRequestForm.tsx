          ...
          <SlideIn from="left">
            ...
            <div className="mt-8 space-y-4">
              <a href="tel:932844460" className="flex items-center gap-4 text-white/50 hover:text-white transition-colors">
                ...
                <div><div className="text-xs text-white/40">{locale === "pt" ? "Ligue-nos" : "Call us"}</div><div className="font-bold text-lg">932 844 460</div></div>
              </a>
              <a href="https://wa.me/351932844460" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/50 hover:text-white transition-colors">
                ...
                <div><div className="text-xs text-white/40">WhatsApp</div><div className="font-bold text-lg">{locale === "pt" ? "Enviar mensagem" : "Send message"}</div></div>
              </a>
            </div>
          </SlideIn>
          ...
          <SlideIn from="right" delay={0.15}>
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-7 sm:p-10 shadow-2xl">
              ...
              <label className="flex items-start gap-2 text-xs text-foreground/50 cursor-pointer mt-4">
                ...
                <span>{locale === "pt" ? "Aceito a recolha e tratamento dos meus dados pessoais para resposta ao pedido de orçamento, de acordo com o RGPD." : "I consent to the collection and processing of my personal data to respond to my quote request, in accordance with GDPR."}</span>
              </label>
              <MagneticButton type="submit" disabled={status === "sending"} className="mt-4 w-full bg-accent hover:bg-[#4E8C27] disabled:opacity-50 text-white text-lg font-bold py-4 rounded-xl transition-colors shadow-lg shadow-accent/20">
